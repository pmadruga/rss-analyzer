...
class ClaudeCodeClient:
    ...
    def analyze_code(self, prompt: str, file_paths: Optional[List[str]] = None) -> Optional[str]:
        """
    ...
    def review_code_changes(self, changed_files: List[str]) -> Optional[str]:
    ...
    def analyze_errors(self, error_log: str) -> Optional[str]:
    ...
    def optimize_code(self, file_paths: List[str]) -> Optional[str]:
    ...
    def generate_documentation(self, file_paths: List[str]) -> Optional[str]:
    ...
    def pre_commit_review(self) -> Dict[str, Any]:
        ...
        try:
            ...
            changed_files = [
                ...
                if f.strip() and f.strip().endswith(('.py', '.js', '.html', '.css', '.md'))
            ]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Claude Code integration for RSS Analyzer")
    parser.add_argument("command", choices=["check", "review", "analyze-errors", "optimize", "help"])
    ...
    if args.command == "check":
        ...
        print("  python tools/claude_code_integration.py analyze-errors --log-file logs/analyzer.log")
