"""
Refactored Claude Client Module

Anthropic Claude API client using the base client architecture.
Eliminates code duplication while maintaining Claude-specific functionality.
"""
    ...
    def __init__(self, api_key: str, model: str = "claude-3-5-sonnet-20241022"):
        ...
        try:
            ...
            raise APIConnectionError(
                f"Failed to initialize Claude client: {e}", "Claude"
            )
